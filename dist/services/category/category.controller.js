...
const getAllCategories = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await category_service_1.CategoryService.getAllCategories(options);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const softDeleteCategory = (0, catchAsync_1.default)(async (req, res) => {
    const id = req.params.id;
    const result = await category_service_1.CategoryService.softDeleteCategory(id);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
